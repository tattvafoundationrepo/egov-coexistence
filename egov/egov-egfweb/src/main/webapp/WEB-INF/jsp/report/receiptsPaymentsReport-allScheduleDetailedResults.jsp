...
<script>
	function showDetails(glcode) {
		var deptId = "<s:property value="receiptsPayments.department.id"/>";
		var functionaryId = "<s:property value="receiptsPayments.functionary.id"/>";
		var functionName = '<s:property value="functionName"/>';
		var functionId = "<s:property value="receiptsPayments.function.id"/>";
		var fieldId = '<s:property value="receiptsPayments.field.id"/>';
		var fundId = '<s:property value="receiptsPayments.fund.id"/>';
								...
								<div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<th class="bluebgheadtd" width="100%" colspan="5"><strong
												style="font-size: 15px;"><s:property
														value="ulbName" /><br />
												<s:text name="report.receiptsPayments.schedule" /> <s:property
										...
										<tr>
											...
											<s:if test="%{receiptsPayments.funds.size()>1}">
												<s:iterator value="cashFlow.funds" status="stat">
										...
										<s:iterator value="receiptsPayments.entries" status="stat">
											<tr>
												...
												<s:if test="%{receiptsPayments.funds.size()>1}">
													<s:iterator value="receiptsPayments.funds" status="stat">
														<s:if test='%{displayBold == true}'>
