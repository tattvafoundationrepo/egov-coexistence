...
<script>
	function showDetails(glcode) {
		var deptId = "<s:property value="cashFlow.department.id"/>";
		var functionaryId = "<s:property value="cashFlow.functionary.id"/>";
		var functionName = '<s:property value="functionName"/>';
		var functionId = "<s:property value="cashFlow.function.id"/>";
		var fieldId = '<s:property value="cashFlow.field.id"/>';
		var fundId = '<s:property value="cashFlow.fund.id"/>';
								...
								<div>
									<table width="100%" border="0" cellpadding="0" cellspacing="0">
										<tr>
											...
											<th class="bluebgheadtd" width="100%" colspan="5"><strong
												style="font-size: 15px;"><s:property
														value="ulbName" /><br />
												<s:text name="report.cashFlow.schedule" /> <s:property
										...
										<tr>
											...
											<s:if test="%{cashFlow.funds.size()>1}">
										...
										<s:iterator value="cashFlow.entries" status="stat">
											<tr>
