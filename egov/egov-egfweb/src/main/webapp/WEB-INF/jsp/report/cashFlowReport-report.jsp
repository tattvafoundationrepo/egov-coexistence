...
function ViewDetail(){
   ...
   var csrfToken = document.getElementById('csrfTokenValue').value;
  doLoadingMask();
  var url = '/services/EGF/report/cashFlowReport-generateDetailCodeReport.action?showDropDown=false&model.period='+document.getElementById('period').value+'&model.currency='+document.getElementById('currency').value+'&model.financialYear.id='+document.getElementById('financialYear').value+'&model.asOndate='+document.getElementById('asOndate').value+'&_csrf='+csrfToken;
    YAHOO.util.Connect.asyncRequest('POST', url, callback, null);
    return true;
   }
 return false;
...
<div id="non-printable">
  <s:form name="cashFlowReport" action="cashFlowReport"
    theme="simple">
    <div class="formmainbox">
      <div class="formheading"></div>
      <div class="subheadnew"><s:text name="CashFlowReport"/> </div>
