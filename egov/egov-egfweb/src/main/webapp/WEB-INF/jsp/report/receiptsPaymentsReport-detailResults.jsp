        ...
        <td>
          <div align="center">
            ...
            <table border="0" cellspacing="0" cellpadding="0"
              ...
              <s:iterator value="receiptandPaymentStatement.ieEntries"
                status="stat">
                <tr>
                  ...
                  <s:iterator value="receiptandPaymentStatement.funds"
                    status="stat">
                    <td class="blueborderfortd">
                      <div align="right">
