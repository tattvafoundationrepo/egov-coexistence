...
@Service
public class ReceiptsPaymentsService extends PersistenceService<CChartOfAccountDetail, Long> {
    public ReceiptsPaymentsService(Class<CChartOfAccountDetail> type) {
		super(type);
	}
    
    public ReceiptsPaymentsService() {
...
*/
	...
	public void populateRPStatement(Statement receiptsPaymentsStatement) {
	 ...
	 * 
	 * List<Object[]> generalLedgerData =
	 * chartOfAccountsRepository.Glcode("1100102", "1203001");
	 * 
	 * //chartOfAccountsRepository.findGeneralLedgerDataBetweenGLCodes( );
	 * 
	 * //1 BigDecimal totalDebitAmt_1100102_1203001= BigDecimal.ZERO; for (Object[]
	 * row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal) row[6]; //
	 * Assuming index 6 contains debit amount totalDebitAmt_1100102_1203001 =
	 * totalDebitAmt_1100102_1203001.add(debitAmount);
	 * 
	 * } reportMap.put("taxationCurrentYear",
	 * totalDebitAmt_1100102_1203001.toString()); //2 generalLedgerData =
	 * chartOfAccountsRepository.Glcode("1301001", "1504103"); BigDecimal
	 * totalDebitAmt_1301001_1504103=BigDecimal.ZERO; for (Object[] row :
	 * generalLedgerData) { BigDecimal debitAmount = (BigDecimal) row[6]; //
	 * Assuming index 6 contains debit amount totalDebitAmt_1301001_1504103 =
	 * totalDebitAmt_1301001_1504103.add(debitAmount);
	 * 
	 * } reportMap.put("salesofgoodsandservicesCurrentYear",
	 * totalDebitAmt_1301001_1504103.toString());
	 * 
	 * 
	 * //3 generalLedgerData = chartOfAccountsRepository.Glcode("1601001",
	 * "1601099"); BigDecimal totalDebitAmt_1601001_1601099=BigDecimal.ZERO; for
	 * (Object[] row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal)
	 * row[6]; // Assuming index 6 contains debit amount
	 * totalDebitAmt_1601001_1601099 =
	 * totalDebitAmt_1601001_1601099.add(debitAmount);
	 * 
	 * }
	 * reportMap.put("grantgeneralgrantscurrentyear",totalDebitAmt_1601001_1601099.
	 * toString());
	 * 
	 * 
	 * //4 generalLedgerData = chartOfAccountsRepository.Glcode("1701001",
	 * "1701099"); BigDecimal totalDebitAmt_1701001_1701099=BigDecimal.ZERO; for
	 * (Object[] row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal)
	 * row[6]; // Assuming index 6 contains debit amount
	 * totalDebitAmt_1701001_1701099 =
	 * totalDebitAmt_1701001_1701099.add(debitAmount);
	 * 
	 * } reportMap.put("InterestReceivedcurrentyear",totalDebitAmt_1701001_1701099.
	 * toString());
	 * 
	 * //5 generalLedgerData = chartOfAccountsRepository.Glcode("1806001",
	 * "1901002"); BigDecimal totalDebitAmt_1806001_1901002=BigDecimal.ZERO; for
	 * (Object[] row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal)
	 * row[6]; // Assuming index 6 contains debit amount
	 * totalDebitAmt_1806001_1901002 =
	 * totalDebitAmt_1806001_1901002.add(debitAmount);
	 * 
	 * } reportMap.put("otherreceiptcurrentyear",totalDebitAmt_1806001_1901002.
	 * toString());
	 * 
	 * 
	 * 
	 * //6 generalLedgerData = chartOfAccountsRepository.Glcode("2101001",
	 * "2104099"); BigDecimal totalDebitAmt_2101001_2104099=BigDecimal.ZERO; for
	 * (Object[] row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal)
	 * row[7]; // Assuming index 6 contains debit amount
	 * totalDebitAmt_2101001_2104099 =
	 * totalDebitAmt_2101001_2104099.add(debitAmount);
	 * 
	 * } reportMap.put("employeecostcurrentyear",totalDebitAmt_2101001_2104099.
	 * toString());
	 * 
	 * 
	 * 
	 * 
	 * 
	 * //7 generalLedgerData = chartOfAccountsRepository.Glcode("2303001",
	 * "2303099"); BigDecimal totalDebitAmt_2303001_2303099=BigDecimal.ZERO; for
	 * (Object[] row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal)
	 * row[7]; // Assuming index 6 contains debit amount
	 * totalDebitAmt_2303001_2303099 =
	 * totalDebitAmt_2303001_2303099.add(debitAmount);
	 * 
	 * }
	 ...
	 * 
	 * 
	 * //8 generalLedgerData = chartOfAccountsRepository.Glcode("2406000",
	 * "2406099"); BigDecimal totalDebitAmt_2406000_2406099=BigDecimal.ZERO; for
	 * (Object[] row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal)
	 * row[7]; // Assuming index 6 contains debit amount
	 * totalDebitAmt_2406000_2406099 =
	 * totalDebitAmt_2406000_2406099.add(debitAmount);
	 * 
	 * } reportMap.put("interestPaidCurrentyear",totalDebitAmt_2406000_2406099.
	 * toString());
	 * 
	 * 
	 * 
	 * //2201000' AND '2901001 //9 generalLedgerData =
	 * chartOfAccountsRepository.Glcode("2201000", "2901001"); BigDecimal
	 * totalDebitAmt_2201000_2901001=BigDecimal.ZERO; for (Object[] row :
	 * generalLedgerData) { BigDecimal debitAmount = (BigDecimal) row[7]; //
	 * Assuming index 6 contains debit amount totalDebitAmt_2201000_2901001 =
	 * totalDebitAmt_2201000_2901001.add(debitAmount);
	 * 
	 * } reportMap.put("otherpaymentcurrentyear",totalDebitAmt_2201000_2901001.
	 * toString());
	 * 
	 * 
	 * 
	 ...
	 * 
	 * //11 generalLedgerData = chartOfAccountsRepository.Glcode("4101000",
	 * "4108099"); BigDecimal totalDebitAmt_4101000_4108099=BigDecimal.ZERO; for
	 * (Object[] row : generalLedgerData) { BigDecimal debitAmount = (BigDecimal)
	 * row[7]; // Assuming index 6 contains debit amount
	 * totalDebitAmt_4101000_4108099 =
	 * totalDebitAmt_4101000_4108099.add(debitAmount);
	 * 
	 * } reportMap.put("purchaseofassetscurrentyear",totalDebitAmt_4101000_4108099.
	 * toString());
	 * 
	 * 
	 * 
	 * 
	 * //12 // BETWEEN '4121001' AND '4123008 generalLedgerData =
	 * chartOfAccountsRepository.Glcode("4121001", "4123008"); BigDecimal
	 * totalDebitAmt_4121001_4123008=BigDecimal.ZERO; for (Object[] row :
	 * generalLedgerData) { BigDecimal debitAmount = (BigDecimal) row[7]; //
	 * Assuming index 6 contains debit amount totalDebitAmt_4121001_4123008 =
	 * totalDebitAmt_4121001_4123008.add(debitAmount);
	 * 
	 * } reportMap.put("Specialfundscurrentyear",totalDebitAmt_4121001_4123008.
	 * toString());
	 * 
	 * 
	 * generalLedgerData = chartOfAccountsRepository.Glcode("4201000", "4208099");
	 * BigDecimal totalDebitAmt_4201000_4208099=BigDecimal.ZERO; for (Object[] row :
	 * generalLedgerData) { BigDecimal debitAmount = (BigDecimal) row[7]; //
	 * Assuming index 6 contains debit amount totalDebitAmt_4201000_4208099 =
	 * totalDebitAmt_4201000_4208099.add(debitAmount);
	 * 
	 * } reportMap.put("PurchaseofInvestmentscurrentyear",
	 * totalDebitAmt_4201000_4208099.toString());
	 * 
	 * 
	 * 
	 * 
	 ...
	 * BigDecimal totalDebitAmt_2400000_2408099=BigDecimal.ZERO; for (Object[] row :
	 * generalLedgerData) { BigDecimal debitAmount = (BigDecimal) row[7]; //
	 * Assuming index 6 contains debit amount totalDebitAmt_2400000_2408099 =
	 * totalDebitAmt_2400000_2408099.add(debitAmount);
	 * 
	 * }
	 ...
	 * 
	 * BigDecimal
	 * netCash1=totalDebitAmt_1100102_1203001.add(totalDebitAmt_1301001_1504103).add
	 * (totalDebitAmt_1601001_1601099).add(totalDebitAmt_1701001_1701099).add(
	 * totalDebitAmt_1806001_1901002).add(totalDebitAmt_2101001_2104099).add(
	 * totalDebitAmt_2303001_2303099).add(totalDebitAmt_2406000_2406099).add(
	 * totalDebitAmt_2201000_2901001); reportMap.put("netCash1",
	 * netCash1.toString());
	 * 
	 * 
	 * 
	 * 
	 * BigDecimal
	 * netCash2=totalDebitAmt_4101000_4108099.add(totalDebitAmt_4121001_4123008).add
	 * (totalDebitAmt_4201000_4208099); reportMap.put("netCash2",
	 * netCash2.toString());
	 * 
	 * 
	 * 
	...
	public Map<String,String> fetchReportData() {
		...
		reportMap.put("taxrevenuecurrentyeartt", totalDebitAmt_1100102_1203001.toString());
		//2
		return reportMap;
