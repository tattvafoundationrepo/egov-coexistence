...
public class PropertyTaxReceiptRegisterService implements EntityTypeService{
    ...
    public List<PropertyTaxReceiptRegister> getAlllDatas(PropertyTaxReceiptRegister pt){
    	List<PropertyTaxReceiptRegister> propertyTaxReceiptRegister = propertyTaxReceiptRegisterRepository.findAll();
         ...
         String sqlQuery1 = "SELECT COALESCE(MAX(id), 0) FROM doiwala.voucherheader";
         ...
         String currentFinancialYear = currentDates.format(DateTimeFormatter.ofPattern("2021-22")); 
         ...
         int startNumber = 100000000 + maxVcId.intValue(); // Update startNumber based on nextId
         String formattedId = String.format("%09d", startNumber);
         ...
         Date currentDate = calendar.getTime();
         	...
         	cVoucherHeader.setFiscalPeriodId(20);
