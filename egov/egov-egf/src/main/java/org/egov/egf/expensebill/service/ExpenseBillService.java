...
//    	Long userId = ApplicationThreadLocals.getUserId();
    ...
    public synchronized String generateExpBillNumber() {
        ...
        Optional<String> latestBillNumber = getLastExpenseBillNumber();
        ...
        String billNumber = "Exp/001/" + financialYear + "/" + "0000" +(Integer.parseInt(lastNumber[0])+1); 
        
        return billNumber;
        
        }
        else {
            return "Exp/001/" + financialYear + "/" + "00001";
        }
    }
    ...
    //added by Navajit
    public Optional<String> getLastExpenseBillNumber() {
        return expenseBillRepository.findMaxBillNumberStartingWithExp();
    }
}
